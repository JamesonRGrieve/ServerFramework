...
def _redaction_patcher(record):
    ...
    try:
        from lib.RequestContext import get_correlation_id
...
class _ContextEnrichingReporter(ErrorReporter):
    ...
    def report(self, exception: BaseException, context: Mapping[str, Any]) -> None:
        ...
        try:
            from lib.RequestContext import get_correlation_id, get_request_user
            ...
            pass
        try:
            from lib.ProviderHTTPClient import get_traceparent
