...
class AbstractTest:
    ...
    def model_class(self) -> BaseModel:
        if CategoryOfTest.DATABASE in self.test_config.categories:
            ...
            return self.class_under_test.Model  # type: ignore[union-attr, no-any-return]
        elif CategoryOfTest.ENDPOINT in self.test_config.categories:
            return self.class_under_test.manager_class.Model  # type: ignore[union-attr, no-any-return]
        else:
