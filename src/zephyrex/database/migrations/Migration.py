...
class MigrationManager:
    ...
    def env_import_module_from_file(file_path, module_name):
        ...
        try:
            ...
            full_module_name = f"zephyrex.database.{module_name}"
    ...
    def _compute_migration_order(self, extensions: List[str]) -> List[str]:
        ...
        from zephyrex.database.MigrationOrdering import (
    ...
    def _setup_python_path(self):
        ...
        This honors:
          ...
          3. The bundled ``<src>/extensions`` location when neither override
             is set.
        """
        from zephyrex.lib.Paths import extensions_path as resolve_extensions_path
