        ...
        try:
            ...
            if hasattr(db_cls, "deleted_at"):
                ...
                if (
                    ...
                    and getattr(tombstone, "deleted_at", None) is not None
                ):
                    if (
                        hasattr(tombstone, "privacy_erased")
                        and tombstone.privacy_erased
                    ):
                        raise HTTPException(
                            status_code=451, detail="Unavailable for legal reasons"
                        )
