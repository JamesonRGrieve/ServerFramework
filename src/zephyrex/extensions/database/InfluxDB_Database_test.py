...
#             "zephyrex.extensions.database.InfluxDB.InfluxDBClient",
...
#             "zephyrex.extensions.database.InfluxDB.has_influxdb2", True
#         )
#         patcher_client = patch(
#             "zephyrex.extensions.database.InfluxDB.InfluxDBClient2",
#             return_value=mock_influxdb_v2_client,
#         )
#         patcher_synchronous = patch("zephyrex.extensions.database.InfluxDB.SYNCHRONOUS")
...
#         with patch("zephyrex.extensions.database.InfluxDB.has_influxdb2", False):
#             provider = InfluxDBProvider(
#                 influxdb_version="2",
#                 extension_id=self.extension_id,
#                 **self.provider_init_params,
...
#         with patch("zephyrex.extensions.database.InfluxDB.InfluxDBClient") as mock_client_class:
#             mock_client = MagicMock()
...
#         with patch("zephyrex.extensions.database.InfluxDB.has_influxdb2", True):
#             with patch(
#                 "zephyrex.extensions.database.InfluxDB.InfluxDBClient2"
...
#         with patch("zephyrex.extensions.database.InfluxDB.InfluxDBClient"):
#             provider = InfluxDBProvider(
#                 influxdb_version="1",
#                 database_host="localhost",
#                 extension_id=self.extension_id,
...
#         with patch("zephyrex.extensions.database.InfluxDB.has_influxdb2", True):
#             with patch("zephyrex.extensions.database.InfluxDB.InfluxDBClient2"):
#                 provider = InfluxDBProvider(
#                     influxdb_version="2",
#                     database_host="localhost",
#                     influxdb_token="test_token",
