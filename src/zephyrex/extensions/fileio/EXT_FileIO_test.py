...
class TestPathContainment:
    ...
    def _provider(self):
        ...
        class _Concrete(AbstractFileIOProvider):
            ...
            async def read_file(self, file_path, offset=0, length=-1):
                return ""

            async def write_file(self, *args, **kwargs):
                return ""

            async def append_to_file(self, file_path, content):
                return ""
            ...
            async def create_directory(self, directory_path, exist_ok=True):
                return ""

            async def delete_directory(self, *args, **kwargs):
                return ""

            async def get_file_info(self, file_path):
                return {}

            async def execute_file(self, file_path, arguments=None):
                return ""

            async def is_path_accessible(self, path):
                return True
