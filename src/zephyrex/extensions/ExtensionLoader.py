...
under BOTH:
  ...
  * ``zephyrex_ext_<extension>_<file>`` -- a globally unique synthesized
...
def _synthesized_name(extension_name: str, file_stem: str) -> str:
    ...
    return f"zephyrex_ext_{extension_name}_{file_stem}"
...
def load_extension_module(
    ...
    # ``obj.__module__ == "zephyrex.extensions.payment.BLL_Payment"``) keep working.
