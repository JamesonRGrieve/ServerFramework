...
class TransientExternalError(BaseExternalError):
    ...
    runbook_url: ClassVar[Optional[str]] = (
        "https://docs.zephyrex.dev/runbooks/transient-external-error"
    )
...
class AuthExternalError(BaseExternalError):
    ...
    runbook_url: ClassVar[Optional[str]] = (
        "https://docs.zephyrex.dev/runbooks/auth-external-error"
    )
...
class InvalidInputExternalError(BaseExternalError):
    ...
    runbook_url: ClassVar[Optional[str]] = (
        "https://docs.zephyrex.dev/runbooks/invalid-input-external-error"
    )
...
class RateLimitExternalError(BaseExternalError):
    ...
    runbook_url: ClassVar[Optional[str]] = (
        "https://docs.zephyrex.dev/runbooks/rate-limit-external-error"
    )
...
class PermanentExternalError(BaseExternalError):
    ...
    runbook_url: ClassVar[Optional[str]] = (
        "https://docs.zephyrex.dev/runbooks/permanent-external-error"
    )
