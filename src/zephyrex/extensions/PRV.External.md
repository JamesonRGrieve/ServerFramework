...
from zephyrex.extensions.payment.models.StripeProductModel import StripeProductModel
...
```python
from zephyrex.extensions.payment.managers.StripeProductManager import StripeProductManager
...
```python
from zephyrex.endpoints.AbstractEPRouter import AbstractEPRouter
...
```python
from zephyrex.extensions.AbstractExternalModel import AbstractExternalModel, create_external_reference_model
