...
from zephyrex.extensions.MigrationOwnership import (
...
def test_file_path_inferred_from_module():
    class FakeModel:
        __module__ = "zephyrex.extensions.payment.BLL_Payment"
...
def test_core_module_returns_none():
    class FakeModel:
        __module__ = "zephyrex.logic.BLL_Auth"
...
def test_list_table_ownership():
    class CoreModel:
        __module__ = "zephyrex.database.DB_Core"
