...
#         with patch("zephyrex.extensions.meta_logging.EXT_Meta_Logging.env") as mock_env:
...
#             with patch(
#                 "zephyrex.extensions.meta_logging.EXT_Meta_Logging.AbstractStaticExtension"
#             ) as mock_abs:
...
#                 with patch(
#                     "zephyrex.extensions.meta_logging.BLL_Meta_Logging.AuditLogModel",
#                     mock_audit_model,
#                 ):
#                     extension = EXT_Meta_Logging()
...
#                 with patch(
#                     "zephyrex.extensions.meta_logging.BLL_Meta_Logging.FailedLoginAttemptModel",
...
#                 with patch(
#                     "zephyrex.extensions.meta_logging.BLL_Meta_Logging.SystemLogModel",
#                     mock_system_model,
#                 ):
#                     extension = EXT_Meta_Logging()
#                     extension.logging_manager = mock_logging_manager
...
#             ):
#                 with patch(
#                     "zephyrex.extensions.meta_logging.BLL_Meta_Logging.MetaLoggingManager"
