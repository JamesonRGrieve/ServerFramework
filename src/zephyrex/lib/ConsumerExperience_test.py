...
These verify that a consumer who pip-installs zephyrex and provides
...
class TestExtensionPathResolution:
    ...
    def test_set_extensions_root_updates_path(self, tmp_path):
        ...
        ext_path.mkdir()
        from zephyrex import set_extensions_root
        from zephyrex.lib.Paths import extensions_dir
...
class TestDatabasePathDefault:
    def test_sqlite_defaults_to_tempdir(self, monkeypatch):
        ...
        from zephyrex.database.DatabaseManager import get_database_info
