...
class TestTypeNameHelper:
    ...
    def test_basic_types(self, annotation, expected):
        from zephyrex.logic.EventBus_SchemaCheck import _type_name
...
class TestSafeJsonify:
    ...
    def test_primitives_pass_through(self, value, expected):
        from zephyrex.logic.EventBus_SchemaCheck import _safe_jsonify
...
class TestIsPydanticUndefined:
    def test_pydantic_undefined(self):
        ...
        from zephyrex.logic.EventBus_SchemaCheck import _is_pydantic_undefined
...
class TestDiscoverEventClasses:
    def test_discovers_from_module_with_events(self):
        from zephyrex.logic.EventBus_SchemaCheck import discover_event_classes

        found = discover_event_classes(["zephyrex.logic.EventBus"])
