...
from zephyrex.logic.AbstractService import AbstractService, ServiceRegistry
...
class TestAbstractService:
    ...
    def test_service_pause_when_not_running(self):
        ...
        with patch("zephyrex.lib.Logging.logger.warning") as mock_logger:
            service.pause()
    ...
    def test_service_registry_error_handling(self):
        ...
        with patch("zephyrex.lib.Logging.logger.error") as mock_logger:
            ServiceRegistry.start_all()
            mock_logger.assert_called()
