...
# Register the default identity/auth manager with the code-generation engine so
# lib/ resolves auth through the AuthProvider contract rather than importing this
# concrete manager (issue #221). A consumer can register an alternative manager
# exposing the same surface without editing lib/.
