...
from serverframework.extensions.payment.BLL_Payment import (
...
class TestPayment_UserManager(CoreUserManagerTests, ExtensionServerMixin):
    ...
    def test_subscription_validation_hook_bypass(self, admin_a, team_a):
        ...
        if root_email:
            ...
            from serverframework.extensions.payment.BLL_Payment import validate_subscription_on_login
            from serverframework.logic.AbstractLogicManager import HookContext, HookTiming
