...
from serverframework.lib.Dependencies import Dependencies, EXT_Dependency, PIP_Dependency, SYS_Dependency
...
```python
from serverframework.logic.AbstractLogicManager import hook_bll, HookContext, HookTiming
...
```python
from serverframework.extensions.AbstractExtensionProvider import ability
...
```python
# In PRV_Stripe.py
from serverframework.extensions.AbstractExternalModel import AbstractExternalModel, AbstractExternalManager
...
```python
from serverframework.extensions.AbstractExternalModel import external_navigation_property
...
from serverframework.lib.Pydantic2SQLAlchemy import extension_model, RemoveField
from serverframework.logic.BLL_Auth import UserModel  # Import existing model
...
class EXT_MyExtension(AbstractStaticExtension):
    ...
    def root(cls):
        ...
        try:
            ...
            from serverframework.logic.BLL_Providers import RotationManager, RotationModel
...
```python
from serverframework.logic.AbstractLogicManager import AbstractBLLManager, ApplicationModel, DatabaseMixin
...
from serverframework.endpoints.AbstractEndpointRouter import AbstractEPRouter
...
from serverframework.logic.AbstractLogicManager import ApplicationModel, DatabaseMixin
...
from serverframework.extensions.AbstractExtensionProvider import AbstractStaticProvider, ability
