...
def test_sync_pipeline_registers_subgraph_and_lifts_models(monkeypatch):
    ...
    from serverframework.extensions.federation.BLL_Federation_GQL import global_registry
...
def test_sync_pipeline_handles_rest_descriptors():
    from serverframework.extensions.federation.BLL_Federation_REST import RESTUpstreamTransport
