...
class EXT_Meta_Logging(AbstractStaticExtension):
    ...
    def _get_model_registry(self):
        ...
        try:
            from serverframework import app  # type: ignore
    ...
    def _initialize_logging_manager(self):
        ...
        try:
            if self.influxdb_available:
                from serverframework.extensions.meta_logging.BLL_Meta_Logging import MetaLoggingManager
    ...
    async def log_audit_event(
        ...
        try:
            from serverframework.extensions.meta_logging.BLL_Meta_Logging import AuditLogModel
    ...
    async def log_failed_login(
        ...
        try:
            from serverframework.extensions.meta_logging.BLL_Meta_Logging import FailedLoginAttemptModel
    ...
    async def log_system_event(
        ...
        try:
            from serverframework.extensions.meta_logging.BLL_Meta_Logging import SystemLogModel
    ...
    def get_provider_class(cls, provider_name: str):
        ...
        provider_map = {
            "file": "serverframework.extensions.meta_logging.providers.FileLogProvider",
            "console": "serverframework.extensions.meta_logging.providers.ConsoleLogProvider",
            "database": "serverframework.extensions.meta_logging.providers.DatabaseLogProvider",
            "remote": "serverframework.extensions.meta_logging.providers.RemoteLogProvider",
        }
