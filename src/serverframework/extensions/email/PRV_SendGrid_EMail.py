...
def _build_auth_strategy(strategy_name: str, **kwargs):
    ...
    """
    try:
        from serverframework.extensions.AuthStrategy import APIKeyAuth, BasicAuth
...
class SendgridProvider(AbstractEmailProvider):
    ...
    def health_check(cls) -> HealthReport:
        ...
        try:
            ...
            from serverframework.lib.ProviderHTTPClient import ClientPolicy, get_sync_client
...
class Smtp2goProvider(AbstractEmailProvider):
    ...
    async def send_email(
        ...
        try:
            ...
            from serverframework.lib.ProviderHTTPClient import ClientPolicy, get_async_client
