...
from serverframework.extensions.MigrationOwnership import (
...
def test_file_path_inferred_from_module():
    class FakeModel:
        __module__ = "serverframework.extensions.payment.BLL_Payment"
...
def test_file_path_inferred_from_synthesized_name():
    ...
    class FakeModel:
        __module__ = "serverframework.extensions.auth_mfa.BLL_AuthMFA"
...
def test_core_module_returns_none():
    class FakeModel:
        __module__ = "serverframework.logic.BLL_Auth"
...
def test_list_table_ownership():
    class CoreModel:
        __module__ = "serverframework.database.DB_Core"
