...
from serverframework.logic.BLL_Extensions import AbilityModel, ExtensionModel
...
class RotationManager(AbstractBLLManager, RouterMixin):
    ...
    def _load_rotation_policy_module(self):
        ...
        """
        try:
            from serverframework.extensions import ExternalErrors  # type: ignore
    ...
    def _rotate_chain(
        ...
        *,
        ...
        if mode_value == "queue_and_retry":
            ...
            from serverframework.logic.Outbox import OutboxEntry
            ...
            from serverframework.extensions.ExternalErrors import QueuedForRetry
        ...
        if mode_value == "silent_drop":
            ...
            from serverframework.extensions.ExternalErrors import SilentDropped
