...
from serverframework.database.StaticPermissions import ROOT_ID
...
from serverframework.logic.AbstractLogicManager import ApplicationModel, UpdateMixinModel
...
from serverframework.logic.AbstractService import AbstractService, ServiceRegistry
...
class TestAbstractService:
    ...
    def test_service_pause_when_not_running(self):
        ...
        with patch("serverframework.lib.Logging.logger.warning") as mock_logger:
            service.pause()
    ...
    def test_service_registry_error_handling(self):
        ...
        with patch("serverframework.lib.Logging.logger.error") as mock_logger:
            ServiceRegistry.start_all()
            mock_logger.assert_called()
