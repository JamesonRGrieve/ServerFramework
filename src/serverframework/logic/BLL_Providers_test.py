...
from serverframework.logic.AbstractBLLTest import AbstractBLLTest, CategoryOfTest, ClassOfTestsConfig
    ...
    parent_entities = [
        ...
        ParentEntity(
            ...
            test_class=lambda: __import__(
                "serverframework.logic.BLL_Extensions_test", fromlist=["TestExtensionManager"]
...
class TestProviderExtensionAbilityManager(AbstractBLLTest):
    ...
    parent_entities = [
        ...
        ParentEntity(
            ...
            test_class=lambda: __import__(
                "serverframework.logic.BLL_Extensions_test", fromlist=["TestAbilityManager"]
            ).TestAbilityManager(),
        ),
    ]
