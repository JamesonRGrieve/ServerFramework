...
# @pytest.mark.dependency(scope="session", depends=["serverframework.logic.AbstractLogicManager_test"])
class AbstractBLLTest(AbstractTest):
    ...
    def test_hooks(self, admin_a, team_a, server, model_registry):
        ...
        from serverframework.logic.AbstractLogicManager import HookRegistry
