...
from serverframework.logic.Outbox import InMemoryOutboxStore
...
try:
    from serverframework.logic import BLL_Providers as _bll_mod  # canonical reference for the
    # OLD module — `_scoped_import` from `lib/Pydantic_test.py` may
    # replace `sys.modules["serverframework.logic.BLL_Providers"]` with a fresh module
