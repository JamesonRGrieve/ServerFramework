...
def get(self, **kwargs) -> Any:
    ...
    if entity is None:
        from serverframework.endpoints.AbstractEndpointRouter import ResourceNotFoundError
...
def child_manager(self):
    ...
    if self._child_manager is None:
        from serverframework.logic.BLL_Child import ChildManager  # Import at runtime
        self._child_manager = ChildManager(
            model_registry=self.model_registry,
            requester_id=self.requester.id,
            target_id=self.target_id,
