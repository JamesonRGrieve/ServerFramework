...
class BaseMixin:
    ...
    def count(
        ...
        **kwargs,
        ...
        if check_permissions:
            from serverframework.database.StaticPermissions import is_root_id as _is_root
    ...
    def exists(
        ...
        **kwargs,
        ...
        from serverframework.database.StaticPermissions import PermissionType, is_root_id
...
def create_reference_mixin(target_entity, **kwargs):
    ...
    RefMixin.__module__ = "serverframework.database.AbstractDatabaseEntity"
    ...
    OptionalRefMixin.__module__ = "serverframework.database.AbstractDatabaseEntity"
