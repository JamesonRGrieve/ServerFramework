...
from serverframework.database import StaticSeeder as static_seeder
...
def _get_extension_name(pydantic_model) -> str:
    ...
    if module_name.startswith("extensions."):
        ...
        if len(parts) >= 2:
            return parts[1]  # e.g., "auth_mfa" from "serverframework.extensions.auth_mfa.BLL_Auth_MFA"
    return "unknown"
...
def _find_core_models_with_seed_data():
    ...
    for module_name, module in sys.modules.items():
        if module and module_name.startswith("serverframework.logic.BLL_"):
...
class TestSeedDataGeneration:
    ...
    def test_provider_model_seed_data_generation(self):
        ...
        from serverframework.extensions.AbstractExtensionProvider import ExtensionRegistry
        from serverframework.logic.BLL_Providers import ProviderModel
    ...
    def test_provider_extension_model_uses_placeholders(self):
        ...
        from serverframework.logic.BLL_Providers import ProviderExtensionModel
    ...
    def test_rotation_model_uses_extension_placeholder(self):
        ...
        from serverframework.extensions.AbstractExtensionProvider import ExtensionRegistry
        from serverframework.logic.BLL_Providers import RotationModel
    ...
    def test_placeholder_resolution_handles_legacy_format(self):
        ...
        from serverframework.database.DatabaseManager import DatabaseManager
        from serverframework.database.StaticSeeder import _resolve_placeholder_fields
