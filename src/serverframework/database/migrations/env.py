...
from serverframework.lib.Paths import extensions_dir as resolve_extensions_dir
...
def _get_db_manager():
    ...
    if _db_mgr is None:
        db_manager_module = MigrationManager.env_import_module_safely(
            "serverframework.database.DatabaseManager", "Failed to import DatabaseManager"
        )
