...
def can_manage_permissions(
    ...
    bll_modules = [
        ...
        "serverframework.logic.BLL_Providers",
        "serverframework.logic.BLL_Extensions",
    ]
    ...
    if app_extensions_str:
        ...
        for ext_name in extension_names:
            bll_modules.append(
                f"serverframework.extensions.{ext_name}.BLL_{stringcase.pascalcase(ext_name)}"
            )
...
def _get_role_hierarchy_map(db: Session, declarative_base) -> dict:
    ...
    # Local import to break cycle
    from serverframework.database.DatabaseManager import DatabaseManager
    from serverframework.logic.BLL_Auth import RoleModel
...
def generate_permission_filter(
    ...
    # Local imports to break cycle
    from serverframework.database.StaticPermissions import PermissionType  # Local import if needed
    from serverframework.logic.BLL_Auth import RoleModel, TeamModel, UserTeamModel
