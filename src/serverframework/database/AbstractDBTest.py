...
from serverframework.AbstractTest import AbstractTest, CategoryOfTest, ClassOfTestsConfig

# Database session will be provided by the db fixture from conftest.py
from serverframework.database.StaticPermissions import check_permission
from serverframework.lib.Environment import env
from serverframework.lib.Logging import logger
from serverframework.lib.Pydantic import obj_to_dict
from serverframework.lib.Scalability import (
    ScalabilityProfile,
    ScalingMetric,
...
#     scope="session", depends=["serverframework.database.AbstractDatabaseEntity_test"]
# )
@pytest.mark.db
