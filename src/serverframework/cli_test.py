"""Pure-utility argparse tests for ``serverframework.cli``."""
...
from serverframework.cli import main
...
def test_version_prints_and_returns_zero(capsys):
    ...
    # Either "serverframework <X.Y.Z>" or "serverframework version: unknown".
