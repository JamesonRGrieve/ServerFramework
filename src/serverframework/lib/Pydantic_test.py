...
from serverframework.lib.Pydantic import ModelRegistry, PydanticUtility, obj_to_dict
...
class TestModelRegistry:
    ...
    def test_model_registry_with_extensions(self):
        ...
        from serverframework.lib.Pydantic2SQLAlchemy import DatabaseMixin, extension_model
