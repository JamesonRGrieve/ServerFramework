...
The env-var defaults are read through ``serverframework.lib.Environment.env``,
...
from serverframework.lib import SecretEncryption


def _patch_env(monkeypatch, **values):
    """Override ``serverframework.lib.SecretEncryption.env`` to return our values."""
