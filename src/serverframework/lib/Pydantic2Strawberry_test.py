...
from serverframework.lib.AbstractPydantic2Test import AbstractPydanticTestMixin
...
class TestSchemaManager(AbstractPydanticTestMixin):
    ...
    def test_reuses_existing_type_for_duplicate_model_objects(self):
        ...
        first_model = create_model(
            ...
            __base__=BaseModel,
            __module__="serverframework.lib.Pydantic2Strawberry_test",
...
class TestEnumHandling(AbstractPydanticTestMixin):
    ...
    def test_extension_enum_conversion(self):
        ...
        ExtensionEnum.__module__ = "serverframework.extensions.test_extension.models"
